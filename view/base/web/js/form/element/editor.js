define([
    ...
    'SR_Codemirror/js/loadCss',
    'SR_Codemirror/js/codemirror/lib/codemirror'
    ...
    function getRequired(editorConfig) {
        ...
        return _.map(files || [], function (path) {
            return 'SR_Codemirror/js/codemirror/' + path;
        });
    }
    ...
    return Textarea.extend({
        defaults: {
            plugins: {},
            elementTmpl: 'SR_Codemirror/form/element/editor',
            inputClass: '',
            editorConfig: {
                indentUnit: 4,
                lineNumbers: true,
        ...
        plugin: function (name) {
            var self = this,
                path = 'SR_Codemirror/js/form/element/editor-plugins/';
